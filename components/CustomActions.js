  ...
  render() {
    return (
      <View>
        <TouchableOpacity
          accessible={true}
          accessibilityLabel="Options to share location, send an image or cancel"
          accessibilityHint="Share your location or send an image"
